...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_BUDBITT)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_GLISCALE)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE    : SPECIES_BUCCANUB)
