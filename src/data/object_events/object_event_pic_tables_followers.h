...
#if P_FAMILY_BUDBITT
static const struct SpriteFrameImage sPicTable_Budbitt[] = {
    overworld_ascending_frames(gObjectEventPic_Budbitt, 4, 4),
};
static const struct SpriteFrameImage sPicTable_Thornalope[] = {
    overworld_ascending_frames(gObjectEventPic_Thornalope, 4, 4),
};
...
#if P_FAMILY_POMBON
static const struct SpriteFrameImage sPicTable_Pombon[] = {
    overworld_ascending_frames(gObjectEventPic_Pombon, 4, 4),
};
#endif //P_FAMILY_POMBON

#if P_FAMILY_GECQUA
static const struct SpriteFrameImage sPicTable_Gecqua[] = {
