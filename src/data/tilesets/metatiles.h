...
const u16 gMetatiles_GatehouseAlt[] = INCBIN_U16("data/tilesets/secondary/gatehouse_alt/metatiles.bin");
const u16 gMetatileAttributes_GatehouseAlt[] = INCBIN_U16("data/tilesets/secondary/gatehouse_alt/metatile_attributes.bin");
