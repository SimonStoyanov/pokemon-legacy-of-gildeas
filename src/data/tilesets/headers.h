...
const struct Tileset gTileset_Archevale =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Archevale,
    .palettes = gTilesetPalettes_Archevale,
    .metatiles = gMetatiles_Archevale,
    .metatileAttributes = gMetatileAttributes_Archevale,
    .callback = NULL,
};
...
const struct Tileset gTileset_GatehouseAlt =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_GatehouseAlt,
    .palettes = gTilesetPalettes_GatehouseAlt,
    .metatiles = gMetatiles_GatehouseAlt,
    .metatileAttributes = gMetatileAttributes_GatehouseAlt,
    .callback = NULL,
};
