...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_FALINKS_WEST] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Falinks_West,
        .frontPicSize = MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_Falinks_West,
        .backPicSize = MON_COORDS_SIZE(64, 40),
        .backPicYOffset = 15,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_Falinks_West,
        .shinyPalette = gMonShinyPalette_Falinks_West,
        .iconSprite = gMonIcon_Falinks_West,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-7, 5, SHADOW_SIZE_S)
        FOOTPRINT(Falinks)
        OVERWORLD(
            ...
            TRACKS_FOOT,
            sAnimTable_Following,
            gOverworldPalette_Falinks_West,
            gShinyOverworldPalette_Falinks_West
        )
        .levelUpLearnset = sFalinksLevelUpLearnset,
        .teachableLearnset = sFalinksTeachableLearnset,
        .formSpeciesIdTable = sFalinksFormSpeciesIdTable,
