...
#define GILDEAS_TO_NATIONAL(name)     [GILDEAS_DEX_##name - 1] = NATIONAL_DEX_##name
...
// Assigns all Gildeas Dex Indexes to a National Dex Index
static const enum NationalDexOrder sGildeasToNationalOrder[GILDEAS_DEX_COUNT - 1] =
{
    GILDEAS_TO_NATIONAL(BUDBITT),
    GILDEAS_TO_NATIONAL(THORNALOPE),
    GILDEAS_TO_NATIONAL(SYLVAGARD),
    GILDEAS_TO_NATIONAL(GLISCALE),
    GILDEAS_TO_NATIONAL(PYROSHED),
    GILDEAS_TO_NATIONAL(FURNACOBRA),
    GILDEAS_TO_NATIONAL(BUCCANUB),
    GILDEAS_TO_NATIONAL(CORSHARK),
    GILDEAS_TO_NATIONAL(ADMIRAZOR),
    GILDEAS_TO_NATIONAL(WATTREL),
    GILDEAS_TO_NATIONAL(KILOWATTREL),
    GILDEAS_TO_NATIONAL(TEDDIURSA),
    GILDEAS_TO_NATIONAL(URSARING),
    GILDEAS_TO_NATIONAL(URSALUNA),
    GILDEAS_TO_NATIONAL(MAKUHITA),
    GILDEAS_TO_NATIONAL(HARIYAMA),
    GILDEAS_TO_NATIONAL(HANAZEKI),
    GILDEAS_TO_NATIONAL(COMBRISK),
    GILDEAS_TO_NATIONAL(CLACIQUEN),
    GILDEAS_TO_NATIONAL(CUBCHOO),
    GILDEAS_TO_NATIONAL(BEARTIC),
    GILDEAS_TO_NATIONAL(SNEASEL),
    GILDEAS_TO_NATIONAL(WEAVILE),
    GILDEAS_TO_NATIONAL(SNEASLER),
    GILDEAS_TO_NATIONAL(SNOVER),
    GILDEAS_TO_NATIONAL(ABOMASNOW),
    GILDEAS_TO_NATIONAL(GEODUDE),
    GILDEAS_TO_NATIONAL(GRAVELER),
    GILDEAS_TO_NATIONAL(GOLEM),
    GILDEAS_TO_NATIONAL(EEVEE),
    GILDEAS_TO_NATIONAL(VAPOREON),
    GILDEAS_TO_NATIONAL(JOLTEON),
    GILDEAS_TO_NATIONAL(FLAREON),
    GILDEAS_TO_NATIONAL(ESPEON),
    GILDEAS_TO_NATIONAL(UMBREON),
    GILDEAS_TO_NATIONAL(LEAFEON),
    GILDEAS_TO_NATIONAL(GLACEON),
    GILDEAS_TO_NATIONAL(SYLVEON),
    GILDEAS_TO_NATIONAL(DROWZEE),
    GILDEAS_TO_NATIONAL(HYPNO),
    GILDEAS_TO_NATIONAL(HYPMAREA),
    GILDEAS_TO_NATIONAL(CARBINK),
    GILDEAS_TO_NATIONAL(MAGNEMITE),
    GILDEAS_TO_NATIONAL(MAGNETON),
    GILDEAS_TO_NATIONAL(MAGNEZONE),
    //GILDEAS_TO_NATIONAL(CRYOTOX),
    //GILDEAS_TO_NATIONAL(FROSTENCH),
    GILDEAS_TO_NATIONAL(NINCADA),
    GILDEAS_TO_NATIONAL(NINJASK),
    GILDEAS_TO_NATIONAL(SHEDINJA),
    GILDEAS_TO_NATIONAL(GIBLE),
    GILDEAS_TO_NATIONAL(GABITE),
    GILDEAS_TO_NATIONAL(GARCHOMP),
    GILDEAS_TO_NATIONAL(GLIMMET),
    GILDEAS_TO_NATIONAL(GLIMMORA),
        
    GILDEAS_TO_NATIONAL(BROWT),
    GILDEAS_TO_NATIONAL(VERDROW),
    GILDEAS_TO_NATIONAL(TEMPESTREL),
    GILDEAS_TO_NATIONAL(POMBON),
    GILDEAS_TO_NATIONAL(POMBON2),
    GILDEAS_TO_NATIONAL(POMBON3),
    GILDEAS_TO_NATIONAL(GECQUA),
    GILDEAS_TO_NATIONAL(GECQUA2),
    GILDEAS_TO_NATIONAL(GECQUA3),
    GILDEAS_TO_NATIONAL(MAEMPERIFF)
};
...
#include "data/pokemon/level_up_learnsets/gildeas.h" // Legends of Gildeas
...
u32 NationalToRegionalOrder(enum NationalDexOrder nationalNum)
{
    ...
    return NationalToGildeasOrder(nationalNum);
}
...
enum GildeasDexOrder NationalToGildeasOrder(enum NationalDexOrder nationalNum)
{
    ...
    while (gildeasNum < (GILDEAS_DEX_COUNT - 1) && sGildeasToNationalOrder[gildeasNum] != nationalNum)
        gildeasNum++;

    if (gildeasNum >= GILDEAS_DEX_COUNT - 1)
        return 0;
...
u32 SpeciesToRegionalPokedexNum(u16 species)
{
    ...
    return SpeciesToGildeasPokedexNum(species);
}
...
enum GildeasDexOrder SpeciesToGildeasPokedexNum(u16 species)
{
    if (!species)
        return 0;
    return NationalToGildeasOrder(gSpeciesInfo[species].natDexNum);
}
...
enum NationalDexOrder RegionalToNationalOrder(u32 regionalNum)
{
    ...
    return GildeasToNationalOrder(regionalNum);
}
...
{
    if (!gildeasNum || gildeasNum >= GILDEAS_DEX_COUNT)
        return 0;

    return sGildeasToNationalOrder[gildeasNum - 1];
}
...
bool32 IsSpeciesInRegionalDex(u16 species)
{
    ...
    return IsSpeciesInGildeasDex(species);
}
...
{
    if (SpeciesToGildeasPokedexNum(species) > GILDEAS_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
