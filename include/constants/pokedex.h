...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_BUDBITT,
    NATIONAL_DEX_THORNALOPE,
    NATIONAL_DEX_SYLVAGARD,
    NATIONAL_DEX_GLISCALE,
    NATIONAL_DEX_PYROSHED,
    NATIONAL_DEX_FURNACOBRA,
    NATIONAL_DEX_BUCCANUB,
    NATIONAL_DEX_CORSHARK,
    NATIONAL_DEX_ADMIRAZOR,
    NATIONAL_DEX_COMBRISK,
    NATIONAL_DEX_CLACIQUEN,
    NATIONAL_DEX_BROWT,
    NATIONAL_DEX_VERDROW,
    NATIONAL_DEX_TEMPESTREL,
    NATIONAL_DEX_POMBON,
    NATIONAL_DEX_POMBON2,
    NATIONAL_DEX_POMBON3,
    NATIONAL_DEX_GECQUA,
    NATIONAL_DEX_GECQUA2,
    NATIONAL_DEX_GECQUA3,
    NATIONAL_DEX_HANAZEKI,
    NATIONAL_DEX_HYPMAREA,
    NATIONAL_DEX_MAEMPERIFF,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GILDEAS_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_MAEMPERIFF
...
// Hoenn Pokédex order
enum GildeasDexOrder
{
    GILDEAS_DEX_NONE,
    GILDEAS_DEX_BUDBITT,
    GILDEAS_DEX_THORNALOPE,
    GILDEAS_DEX_SYLVAGARD,
    GILDEAS_DEX_GLISCALE,
    GILDEAS_DEX_PYROSHED,
    GILDEAS_DEX_FURNACOBRA,
    GILDEAS_DEX_BUCCANUB,
    GILDEAS_DEX_CORSHARK,
    GILDEAS_DEX_ADMIRAZOR,
    GILDEAS_DEX_WATTREL,
    GILDEAS_DEX_KILOWATTREL,
    GILDEAS_DEX_TEDDIURSA,
    GILDEAS_DEX_URSARING,
    GILDEAS_DEX_URSALUNA,
    GILDEAS_DEX_MAKUHITA,
    GILDEAS_DEX_HARIYAMA,
    GILDEAS_DEX_HANAZEKI,
    GILDEAS_DEX_COMBRISK,
    GILDEAS_DEX_CLACIQUEN,
    GILDEAS_DEX_CUBCHOO,
    GILDEAS_DEX_BEARTIC,
    GILDEAS_DEX_SNEASEL,
    GILDEAS_DEX_WEAVILE,
    GILDEAS_DEX_SNEASLER,
    GILDEAS_DEX_SNOVER,
    GILDEAS_DEX_ABOMASNOW,
    GILDEAS_DEX_GEODUDE,
    GILDEAS_DEX_GRAVELER,
    GILDEAS_DEX_GOLEM,
    GILDEAS_DEX_EEVEE,
    GILDEAS_DEX_VAPOREON,
    GILDEAS_DEX_JOLTEON,
    GILDEAS_DEX_FLAREON,
    GILDEAS_DEX_ESPEON,
    GILDEAS_DEX_UMBREON,
    ...
    GILDEAS_DEX_DROWZEE,
    GILDEAS_DEX_HYPNO,
    GILDEAS_DEX_HYPMAREA,
    GILDEAS_DEX_CARBINK,
    GILDEAS_DEX_MAGNEMITE,
    GILDEAS_DEX_MAGNETON,
    GILDEAS_DEX_MAGNEZONE,
//  GILDEAS_DEX_CRYOTOX,
//  GILDEAS_DEX_FROSTENCH,
    GILDEAS_DEX_NINCADA,
    GILDEAS_DEX_NINJASK,
    GILDEAS_DEX_SHEDINJA,
    GILDEAS_DEX_GIBLE,
    GILDEAS_DEX_GABITE,
    GILDEAS_DEX_GARCHOMP,
    GILDEAS_DEX_GLIMMET,
    GILDEAS_DEX_GLIMMORA,
    GILDEAS_DEX_BROWT,
    GILDEAS_DEX_VERDROW,
    GILDEAS_DEX_TEMPESTREL,
    GILDEAS_DEX_POMBON,
    GILDEAS_DEX_POMBON2,
    GILDEAS_DEX_POMBON3,
    GILDEAS_DEX_GECQUA,
...
#define GILDEAS_DEX_COUNT (GILDEAS_DEX_MAEMPERIFF + 1)

#define REGIONAL_DEX_COUNT (IS_FRLG ? KANTO_DEX_COUNT : GILDEAS_DEX_COUNT)
