...
#define VAR_ARCHEVALE_HOUSE_STATE                        0x408C // 0: FTUE, 1: Normal State, 2: Marshadow found, 3: Champion
...
#define VAR_DEXNAV_STEPS_COUNTER                         0x40F8 // Steps for finding hidden pokemon
