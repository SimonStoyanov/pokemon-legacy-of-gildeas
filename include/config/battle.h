...
#define B_SMART_WILD_AI_FLAG        FLAG_WILD_AI        // If not 0, you can set this flag in a script to enable smart wild pokemon
...
#define B_FLAG_TERA_ORB_CHARGED     FLAG_USE_TERASTAL   // If this flag is set, the Tera Orb is charged. It is automatically set upon healing and cleared upon Terastallizing once configured.
