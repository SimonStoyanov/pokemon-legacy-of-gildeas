...
#define P_GILDEAS_POKEMON                TRUE // LEGENDS OF GILDEAS Pokémon
...
#define P_FAMILY_COALIMP                 P_GILDEAS_POKEMON
#define P_FAMILY_FORGEMLIN               P_GILDEAS_POKEMON
#define P_FAMILY_DEVISMITH               P_GILDEAS_POKEMON
